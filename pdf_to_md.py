...
def pdf_to_md(pdf_path: str, output_dir: str = "output") -> str:
    """
    Convert a single PDF file to Markdown string using do_parse.
    """
    ...
    # 解析后 markdown 的路径
    md_path = os.path.join(output_dir, pdf_file_name, "auto", f"{pdf_file_name}.md")
